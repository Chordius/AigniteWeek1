    ...
    <div className="flex justify-center w-full min-h-screen bg-[#212121] text-white">
      ...
      <main className="pt-36 w-3/4">
        ...
        <div className='flex justify-center'>
          <div className='bg-[#303030] p-4 rounded-2xl w-3/4 shadow-md'>
            <p>Gemini, why did the chicken cross the road at 10 PM?</p>
          </div>
          ...
          <div className='w-[85%] flex flex-col gap-y-3'>
            ...
            <div className='bg-[#303030] p-4 rounded-2xl mb-8 shadow-lg'>
              <p className='text-base'>
                <span className='text-xl font-semibold'>Crossing the Road</span><br/>
                <br/>
                Why did the Chicken Cross the Road?<br/>
                Date:  30 Februari 2025, 10:00 PM<br/>
                Status:  Active<br/>
              </p>
            </div>
